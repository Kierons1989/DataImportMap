      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Upload a CSV file, define table captions, and let our AI assistant help you map columns to create your perfect data table.
          </p>
        </div>
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
          <TabsList className="grid w-full grid-cols-4 bg-white shadow-sm">
            ...
            >
              ...
              {progress.upload && <div className="w-2 h-2 bg-green-500 rounded-full ml-1" />}
            </TabsTrigger>
            <TabsTrigger 
              value="captions" 
              className="flex items-center space-x-2"
            ...
            >
              ...
              {progress.captions && <div className="w-2 h-2 bg-green-500 rounded-full ml-1" />}
            </TabsTrigger>
            <TabsTrigger 
              value="mapping" 
              className="flex items-center space-x-2"
            ...
            >
              ...
              {progress.mapping && <div className="w-2 h-2 bg-green-500 rounded-full ml-1" />}
            </TabsTrigger>
            <TabsTrigger 
              value="preview" 
              className="flex items-center space-x-2"
            ...
            >
              ...
              <span>Preview</span>
              {progress.complete && <div className="w-2 h-2 bg-green-500 rounded-full ml-1" />}
            </TabsTrigger>
          </TabsList>
            ...
            {csvData.length > 0 && (
              <div className="bg-white rounded-lg border border-gray-200 p-6">
                ...
                <div className="text-sm text-gray-600 mb-4">
                  ...
                  Columns: <span className="font-medium">{csvColumns.length}</span> • 
                  Rows: <span className="font-medium">{csvData.length - 1}</span>
                </div>
          ...
          <TabsContent value="mapping" className="grid grid-cols-1 lg:grid-cols-2 gap-6">

  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-slate-100 to-slate-200">
      <div className="text-center">
        ...
        <h1 className="flex items-center justify-center gap-3 text-2xl font-semibold text-slate-800">
          <svg className="h-8 w-8 animate-spin text-slate-400" viewBox="0 0 50 50">
            <circle
